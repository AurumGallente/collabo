...
$default_fonts = array( 'Montserrat', 'My Font One', 'My Font Two', 'Arial' , "'Arial Black'", "'Bookman Old Style'" , "'Comic Sans MS'" ,'Courier', 'Garamond' ,'Georgia' , 'Impact', "'Lucida Console'" , "'Lucida Sans Unicode'" , "'MS Sans Serif'" , 
...
<?php
	...
	WebFontConfig = {
		...
		custom: { families: ['durus' , 'SSAir' , 'SSSocialRegular'], urls: ['<?php bloginfo('template_directory'); ?>/css/icons.css', '<?php bloginfo('template_directory'); ?>/css/ss-icons.css'] }
...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/icon-sc.css">    
