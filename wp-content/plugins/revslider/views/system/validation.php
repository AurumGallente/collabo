...
<div id="rs-validation-wrapper" style="display:<?php echo $displ; ?>">
	...
	<div class="validation-input">
		...
		<p class="validation-description"><?php _e('Please enter your '); ?><strong style="color:#000"><?php _e('CodeCanyon Slider Revolution purchase code / license key'); ?></strong><?php _e('. You can find your key by following the instructions on',REVSLIDER_TEXTDOMAIN); ?><a target="_blank" href="http://www.themepunch.com/home/plugins/wordpress-plugins/revolution-slider-wordpress/where-to-find-the-purchase-code/"><?php _e(' this page.',REVSLIDER_TEXTDOMAIN); ?></a></p>
	</div>
